...
import psutil # non-standard module
import netifaces # non-standard module
import requests # non-standard module
...
def main():
	...
	while (True):
		...
		##### TODO: maybe only update if status string changed

		#root.set_wm_name(status)
		root.set_wm_name(status.encode())
		'''
